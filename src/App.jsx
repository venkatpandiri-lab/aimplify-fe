...
function Linkify({ text, style }) {
  ...
  return <span style={style}>{parts.map((p, i) => URL_RE.test(p) ? <a key={i} href={p} target="_blank" rel="noopener noreferrer" style={{ color: "#0EA5E9", textDecoration: "underline", wordBreak: "break-all" }}>{p}</a> : p)}</span>;
}
